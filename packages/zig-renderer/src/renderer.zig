...
pub fn clayColorToTerminallibColor(color: cl.Color) rl.Color {
    return rl.Color{
        ...
        switch (render_command.command_type) {
            ...
            .text => {
                ...
                rl.drawTextEx(
                    ...
                    clayColorToTerminallibColor(config.text_color),
                );
            },
            .image => {
                ...
                rl.drawTextureEx(
                    ...
                    clayColorToTerminallibColor(tint),
                );
            },
            .scissor_start => {
                rl.beginScissorMode(
            ...
            .rectangle => {
                ...
                if (config.corner_radius.top_left > 0) {
                    ...
                    rl.drawRectangleRounded(
                        ...
                        radius,
                        8,
                        clayColorToTerminallibColor(config.background_color),
                    );
                } else {
                    rl.drawRectangle(
            ...
            .border => {
                ...
                const color = clayColorToTerminallibColor(config.color);
